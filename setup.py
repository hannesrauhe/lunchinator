...
data_files = [('share/lunchinator/sounds', ['sounds/sonar.wav']),
              ('share/lunchinator/images', ['images/webcam.jpg',
                                            ...
                                            'images/lunchinator.svg',
                                            'images/lunchinatorred.png',
                                            'images/lunchinatorred.svg',
                                            'images/lunchinatorgreen.png',
                                            'images/lunchinatorgreen.svg',
                                            'images/lunchinator_chat.png',
                                            'images/me.png',
                                            'images/cancel32.png',
                                            'images/cancel32p.png',
                                            'images/reveal32.png',
                                            'images/reveal32p.png',
                                            'images/retry32.png',
                                            'images/retry32p.png',
                                            'images/up.png',
                                            'images/down.png',
