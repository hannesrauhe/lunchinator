...
class SafeConnector(QObject):
    def __init__(self):
        ...
        self._notifier = QSocketNotifier(self._rsock.fileno(),
                                         QSocketNotifier.Read)
        self._notifier.activated.connect(self._recv)

    homeTimelineUpdated = pyqtSignal(object)
    ...
    twitterLoopStarted = pyqtSignal(object)
    ...
    twitterLoopStopped = pyqtSignal(object)
    ...
    rangeLimiteExceeded = pyqtSignal(object)
    ...
    updatePosted = pyqtSignal(object, object)
    ...
    notAuthenticated = pyqtSignal(object)
